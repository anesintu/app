  ...
  const serviceGroups = [
    {
      ...
      items: ['Листовки', 'Флаеры', 'Буклеты', 'Плакаты'],
    },
    {
      id: 'corporate',
      title: 'Корпоративная полиграфия',
      items: ['Визитки', 'Сертификаты', 'Дипломы', 'Грамоты', 'Блокноты', 'Этикетки', 'Меню для кафе и ресторанов'],
    },
    {
      id: 'image',
      title: 'Имиджевая полиграфия',
      items: ['Календари', 'Каталоги', 'Пригласительные', 'Открытки', 'Цветные журналы'],
    },
    {
      id: 'editions',
