...
const ColorPrintingPage = () => {
  ...
  const serviceGroups = [
    {
      id: 'marketing',
      title: 'Маркетинговая полиграфия',
      items: ['Листовки', 'Флаеры', 'Буклеты', 'Брошюры', 'Плакаты'],
    },
    {
      id: 'corporate',
      title: 'Корпоративная продукция',
      items: ['Визитки', 'Конверты', 'Бейджи', 'Фирменные бланки'],
    },
    {
      id: 'editions',
      title: 'Издания и каталоги',
      items: ['Книги в мягком переплете', 'Книги в твердом переплете', 'Цветные журналы', 'Меню для кафе'],
    },
    {
      id: 'special',
      title: 'Специальные материалы',
      items: ['Печать на дизайнерской бумаге', 'Печать на самоклейке', 'Пригласительные и открытки', 'Календари'],
    },
  ];
        ...
        <div className="container-custom">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-eggshell/70 text-lg md:text-xl leading-relaxed">
              Оперативная и качественная печать любой сложности, независимо от тиража.
              Используем профессиональное оборудование Konica Minolta.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="print-grid">
            ...
            <div className="print-content">
              ...
              <div className="highlight-box">
                <p>Оперативная и качественная печать любой сложности, независимо от тиража</p>
              </div>
