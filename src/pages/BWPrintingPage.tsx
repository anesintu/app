  ...
  const serviceGroups = [
    {
      ...
      items: ['Журналы регистрации', 'Книги учета', 'Бухгалтерские журналы', 'Отчетные формы'],
    },
    {
      id: 'forms',
      title: 'Бланочная продукция',
      items: ['Накладные', 'Счета-фактуры', 'Товарные чеки', 'Доверенности'],
    },
    {
      id: 'cards',
      title: 'Карточки и талоны',
      items: ['Дисконтные карты', 'Талоны', 'Купоны', 'Ваучеры'],
    },
    {
      id: 'docs',
      title: 'Документация',
        ...
        <div className="container-custom">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-eggshell/70 text-lg md:text-xl leading-relaxed">
              Высокоскоростная черно-белая печать документов любой сложности.
              Экономичное решение для больших тиражей.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="print-grid">
            ...
            <div className="print-content">
              ...
              <div className="highlight-box">
                <p>Экономичная печать для документов, журналов учета и бланков</p>
              </div>
